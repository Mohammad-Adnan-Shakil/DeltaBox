      ...
      {p2 && (
        <div className="flex flex-col items-center gap-2 order-1">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-1 text-sm font-semibold text-[var(--color-text-primary)]">{p2.driverName || p2.driver?.name}</p>
            <p className="text-xs text-[var(--color-text-secondary)]">{p2.teamName || p2.team}</p>
      ...
      {p1 && (
        <div className="flex flex-col items-center gap-2 order-2">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-1 text-sm font-semibold text-[var(--color-text-primary)]">{p1.driverName || p1.driver?.name}</p>
            <p className="text-xs text-[var(--color-text-secondary)]">{p1.teamName || p1.team}</p>
      ...
      {p3 && (
        <div className="flex flex-col items-center gap-2 order-3">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-1 text-sm font-semibold text-[var(--color-text-primary)]">{p3.driverName || p3.driver?.name}</p>
            <p className="text-xs text-[var(--color-text-secondary)]">{p3.teamName || p3.team}</p>
